...
if [ ! -d "gmsh-4.8.3-MacOSX-sdk.tgz" ]; then
  wget http://gmsh.info/bin/MacOSX/gmsh-4.8.3-MacOSX-sdk.tgz
  gtar -xf gmsh-4.8.3-MacOSX-sdk.tgz 
  rm -rf gmsh-4.8.3-MacOSX-sdk.tgz 
fi

export GMSHSDK=${PWD}/gmsh-4.8.3-MacOSX-sdk/
export SOLSDK=${PWD}/
