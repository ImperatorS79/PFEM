...
if [ ! -d "gmsh-4.8.3-Windows64-sdk" ]; then
  wget http://gmsh.info/bin/Windows/gmsh-4.8.3-Windows64-sdk.zip
  unzip gmsh-4.8.3-Windows64-sdk.zip 
  rm -rf gmsh-4.8.3-Windows64-sdk.zip
fi

export CGAL_DIR=/c/tools/msys64/mingw64/lib/cmake/CGAL/
export GMSHSDK=${PWD}/gmsh-4.8.3-Windows64-sdk #put gmsh sdk here
...
cp -r ${GMSHSDK}/lib/gmsh-4.8.dll bin
...
cp -r /c/tools/msys64/mingw64/bin/lua54.dll bin
